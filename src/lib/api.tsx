...
export const preview = (body: string): Promise<string> => {
	const url =
		joinUrl([options.baseUrl, 'comment/preview']) + objAsParams(defaultParams);
...
export const reportAbuse = ({
	...
	const url =
		joinUrl([options.baseUrl, 'comment', commentId.toString(), 'reportAbuse']) +
		objAsParams(defaultParams);
...
export const unPickComment = (commentId: number): Promise<CommentResponse> => {
	const url =
		joinUrl([options.baseUrl, 'comment', commentId.toString(), 'unhighlight']) +
		objAsParams(defaultParams);
